    ...
    <div class="flex">
        <div class="w-9/12">
            <div class="border-b pb-2">
                <div>
                    <span
                        class="text-zt_purple/80 tracking-wide font-zt_semibold text-xs uppercase"
                        >{{ title }}</span
                    >
                </div>
                <div class="flex items-center gap-x-3 pt-10">
                    <span class="text-3xl text-gray-500">
                        <font-awesome-icon :icon="page?.meta.icon" class="" />
                    </span>
            ...
            <ContentRenderer id="homeContent" :value="page" :components="components" />
            <hr />
