        ...
        <div class="grid grid-cols-12 gap-x-14">
            <div class="col-span-8 border-b pb-2 border-dashed">
                ...
                <div class="space-y-3 text-sm text-gray-600 text-justify">
                    <p>
                        A Target is the URL of a Web Application, Website, or API. All the following
                        are examples of Targets: Lorem, ipsum dolor sit amet consectetur adipisicing
                        elit. Non facilis sapiente culpa repellendus sunt dolores.
                    </p>
                    <p>
                        If the Target is
                        ...
                        or any other hosts. In other words, the scanner will only scan URLs prefixed
                        by example.com.
                    </p>
                    <p>
                        You can also think of a Target as to how you want to organize your security
                        testing. Imagine you have a big app at
                        <span class="text-zt_purple underline">https://example.com.</span>
                        This app includes different sections or modules that can even be built by
                        different teams. You can split it into different Targets to facilitate your
                        workflows, like
