          ...
          >
            <div v-for="(itemdata, index2) in itemlist.children" :key="index2">
              ...
              >
                ...
                />
                <span v-else class="text-base -translate-y-0.5 text-gray-500">#</span>
                <div class="flex-1 flex items-start space-x-1 text-sm">
                  ...
                  >
                    <MDC v-if="itemdata?.content" :value="itemdata.content" unwrap="p" />
                  </span>
                </div>
              </NuxtLink>
            </div>
      ...
      >
        <div v-for="(item, index) in nav" :key="index">
          ...
          >
            ...
            <div v-for="(itemdata, idx) in itemlist.children" :key="idx">
              <NuxtLink
                class="flex items-start space-x-2 text-nowrap overflow-hidden text-ellipsis max-w-full px-2 py-1 rounded-md hover:bg-gray-200/30"
