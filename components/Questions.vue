    ...
    <div class="w-full">
      ...
      >
        ...
        >
          <div>
            <div
              class="text-base flex justify-between tracking-wide items-center gap-x-5 text-gray-800 font-zt_regular px-6 py-5 cursor-pointer hover:bg-gray-50 bg-white"
              :class="{
                'bg-gray-100 text-gray-700 shadow-md': item.isOpen,
            ...
            <div
              :class="{
                'max-h-52 overflow-y-auto bg-slate-50/40': item.isOpen,
                'max-h-0': !item.isOpen,
              }"
