...
1. **Navigate to Organization Settings**  
   Access the "Organization Settings" section of the ZeroThreat portal to begin adding a user.

 <img src="/Images/image (82).png" alt="Organization Settings" >

2. **Click Add User**  
   Click the <span><img src="/Images/image (84).png" alt="" data-size="original" width="30px"></span> **(Add User)** button to start the process. This opens a form where you can input user details.
...
4. **Save the User**  
   After entering the details, click **Save**. The new user will be added to your organization, and an email invitation will be sent to them.
