...
description: Set up an organization in ZeroThreat to manage teams, resources, and security workflows efficiently.
---
...
* Once all details are filled in, click the **Add Organization** <span><img src="/Images/image (73).png" alt="" width="15%" data-size="line"></span> button to complete the process.
