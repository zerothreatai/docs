...
All discovered APIs and their vulnerabilities are listed under the **Detected APIs** section and **Crawled URIs** in the **Scan Report** tab of the ZeroThreat portal.
...
All Detected API Vulnerabilities
::
...
* **No Code Access Required**: Unlike SAST-based techniques, ZeroThreat does not require access to the source code or repository.
...
* **Full Coverage**: Scans cover both front-end and back-end integrations by interacting with the application end-to-end.
