...
icon: list-check
title: Scan Summary
description: The **Scan Summary** page provides a high-level overview of the security posture of the entire scanned application. It lists key findings allowing you to assess risks at a glance.
...
- **Vulnerabilities by Severity** – A severity-based breakdown (Critical, Medium, Low, and Informational), allowing for prioritization.
