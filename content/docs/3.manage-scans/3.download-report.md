...
##### Report Download Availability
###### Downloading scan reports is not available for free scan credits. You can only download reports for scans performed using purchased credits or under an active subscription plan. Refer to the [**ZeroThreat Plans**](/docs/plans/zerothreat-plans 'mention') for more details.
::
