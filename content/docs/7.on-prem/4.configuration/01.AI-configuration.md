...
::fiqure-img{source="/Images/image (417).png"}
::
...
4. Under **Gemini** AI Provider, toggle Enable Gen AI Configuration (<span><img src="/Images/image (419).png" alt="" width="200px" class="w-32 inline-block"></span>)option
...
::fiqure-img{source="/Images/image (421).png"}
::
...
::fiqure-img{source="/Images/image (423).png"}
::

5. Under **OpenAI** Provider, toggle Enable Gen AI Configuration <span><img src="/Images/image (419).png" width="200px" alt="" class="w-32 inline-block"></span> option
...
::fiqure-img{source="/Images/image (426).png"}
::
...
::fiqure-img{source="/Images/image (427).png"}
::

5. Under **Azure OpenAI** Provider, toggle Enable Gen AI Configuration (<span><img src="/Images/image (419).png" width="200px" alt="" class="w-32 inline-block"></span>) option
