...
5. Provide a name for the token and set an expiry date (recommended).

::fiqure-img{source="/Images/image (421).png" width="90%"}
::

Grant the following permissions at minimum:
...
Next, explore integrations with **GitHub Issues, Azure Boards, Trello, or Jira** to streamline your remediation workflows.