...
**What’s next?**\
Mail notifications are now configured. You can continue with scanning workflows or review [**Automated Pentest Configuration**](automated-pentest-configuration 'mention')