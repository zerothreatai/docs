...
description: When you purchase a **Professional Plan** or **Enterprise Plan** in ZeroThreat, subscription based plans includes unlimited scans for the purchased number of targets throughout the subscription period. To begin using your plan, you must **associate** the subscription with the targets you want to scan.
...
* You’ve purchased a Professional Plan or other eligible subscription plan under the correct organization.
...
::
4. You’ll see your current usage, such as `Available Targets: 1/3`, which means you’ve purchased 3 targets in the subscription, and 1 is currently assigned.

::hint{style="background-color:#f7fcff; border:1px solid #07405a33; color:#1e6995;" icon="circle-info" iconClass="text-sky-600"}
###### The **Active Subscriptions** tab will only appear if your organization has a Professional Plan active.
::
...
3. Toggle the **Assign to Subscription Plan** button next to the target you want to bind.
4. Click **Associate** to confirm.
...
3. Click on **Available Targets** to see all the assigned and unassigned targets.

### Step 2: Remove the Association
...
* **If cooling period is over or once a scan is started** (on the associated target): The de-association will take effect at the end of the billing cycle. Until then, scans can still be performed on the associated target.
