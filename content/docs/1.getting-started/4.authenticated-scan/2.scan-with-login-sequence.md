...
* Click on the **"Record Authentication Sequence"** button <img src="/image (98).png" width="28%" alt="" data-size="inline" style="display:inline; margin:0px; margin-bottom:8px;"> This will open the selected web application in a new tab along with the Zero Threat Recorder Chrome window.
