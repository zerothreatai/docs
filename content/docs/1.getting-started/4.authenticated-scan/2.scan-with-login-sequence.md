...
- In the dashboard within the ZeroThreat portal begin by clicking on **Scan the Target** and choose the application you wish to scan.
    ...
    <img src="/Images/image (97).png" alt="" data-size="original" style="display:block; margin:30px auto;" >

- Next select the scanning server which is close to your target application. &#x20;

::fiqure-img{source="/Images/image (174) .png" width=563}

 <!-- <img src="/Images/image (114).png" alt="" width="563"> -->
...
* Once you’ve selected your target, go to the **Authenticated Scan** section.
  ...
  ::fiqure-img{source="/Images/image (114).png" width=563}
  ::

* Click on the **"Record Authentication Sequence"** button <img src="/Images/image (98).png" width="28%" alt="" data-size="inline" style="display:inline"> This will open the selected web application in a new tab along with the ZeroThreat Recorder Chrome window.
...
- You will be prompted to configure the Recorder before starting the recording.
  ...
  - **Choose the Content Rendering Type**: Select whether the application uses server-side rendering (e.g., WordPress, PHP, ASP.NET) or client-side rendering (e.g., Angular, React, Vue). &#x20;
    ...
    ::fiqure-img{source="/Images/image (115).png"}
    ::
...
::fiqure-img{source="/Images/image (100).png" width=242}

<!-- <img src="/Images/image (100).png" alt="" width="242"> -->
...
- After logging in, navigate few authenticated areas of the target application. The Recorder will capture all these actions, which are crucial for scanning protected sections of the app.
    ...
    <img src="/Images/image (101).png" alt="" style="display:block; margin:5px auto;">

::hint{style="background-color:#f7fcff; border:1px solid #0ea5e933; color:#1e6995;" icon="circle-info" iconClass="text-sky-600"}
...
- Once you have navigated few authenticated sections, log out of the target application. <img src="/Images/image (102).png" width="17%" alt="" style="display:inline; margin:0px; margin-bottom:0px;"/>

- Click on **"Stop Recording"** <img src="/Images/image (103).png" alt="" width="120px" data-size="line" style="display:inline; margin:0px; margin-bottom:0px;"> to stop the recording.
...
- **Login Action**: Tag the request endpoint responsible for logging in.&#x20;
  ...
  ::fiqure-img{source = "/Images/image (175).png"}
...
- **Authenticated Requests**: Tag any request endpoint that is only accessible after login.&#x20; 
  ...
  ::fiqure-img{source = "/Images/image (176).png"}

  ::


- **Log Out Action**: Tag the  request endpoint responsible for logging out or tag the request endpoint from where you clicked on logout button.    

  ::fiqure-img{source = "/Images/image (177).png"}
...
::fiqure-img{source="/Images/image (178).png" width=536}

<!-- <img src="/Images/image (111).png" alt="" width="563"> -->

::

### 9. Monitor the Scan

After starting the scan, monitor its progress and results in the **Scans** section of the ZeroThreat portal.
