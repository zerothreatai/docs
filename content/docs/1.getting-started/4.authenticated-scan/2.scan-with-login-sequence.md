...
* Click on the **"Record Authentication Sequence"** button <img src="/image (98).png" width="28%" alt="" data-size="inline" style="display:inline"> This will open the selected web application in a new tab along with the ZeroThreat Recorder Chrome window.
