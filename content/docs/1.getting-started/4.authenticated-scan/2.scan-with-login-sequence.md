...
- Click on **"Stop Recording"** <img src="/Images/image (103).png" alt="" width="17%" data-size="line" style="display:inline; margin:0px; margin-bottom:0px;"> to stop the recording.
