...
- Click on the **"Record Authentication Sequence"** button <img src="/image (98).png" width="28%" alt="" data-size="inline" style="display:inline; margin-top:0px"> This will open the selected web application in a new tab along with the Zero Threat Recorder Chrome window.
...
- You will be prompted to configure the Recorder before starting the recording.
    ...
    - **Choose the Content Rendering Type**: Select whether the application uses server-side rendering (e.g., WordPress, PHP, ASP.NET) or client-side rendering (e.g., Angular, React, Vue). &#x20;
     ...
     <img src="/image (115).png" alt="" data-size="original" style="display:block;" >
...
- **Login Action**: Tag the HTTP request responsible for logging in.&#x20;<img src="/image (108).png" alt="" style="display:block;" >

<!-- <img src="/image (108).png" alt=""> -->

- **Authenticated Requests**: Tag any HTTP requests that is only accessible after login.&#x20; <img src="/image (109).png" alt="" style="display:block;" >

- **Log Out Action**: Tag the HTTP request responsible for logging out. <img src="/image (110).png" alt="" style="display:block;" >
