...
- Navigate to the **Authenticated Scan** section and click on **Start Authenticated Scan** <img src="/Images/image (132).png" width="180px" alt="" data-size="line" style="display:inline; margin:0px; margin-bottom:0px;"> button.
...
- Click **Record Login State** button
  <span><img src="/Images/image (134).png" width="15%" alt="" data-size="line"></span> in the Recorder window to begin capturing the authentication process.
...
- After successfully logging in, click **Stop Recording** <span><img src="/Images/image (135).png" alt="" width="15%" data-size="line"></span>button in the ZeroThreat Recorder window.
...
- Choose the scanning server and click on start scan and the scan will start immediately. <img src="/Images/image (136).png" alt="" width="200px">
