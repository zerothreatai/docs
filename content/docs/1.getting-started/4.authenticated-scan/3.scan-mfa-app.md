...
- In the ZeroThreat dashboard, click on **"Scan the Target"** and choose the application you wish to scan.
  ...
  <!-- <img src="/Images/image (131).png" alt=""> -->

  ::

- Next choose the scanning server closest to your target application.
- Navigate to the **Authenticated Scan** section and click on **Start Authenticated Scan** <img src="/Images/image (132).png" width="200px" alt="" data-size="line" style="display:inline; margin:0px; margin-bottom:0px;"> button.

  ::fiqure-img{source="/Images/image (133).png"}
  <!-- <img src="/Images/image (133).png" alt=""> -->
...
- Click **Record Login State** button
  <img src="/Images/image (134).png" width="15%" alt="" data-size="line" style="display:inline; margin:0px; margin-bottom:0px;"> in the Recorder window to begin capturing the authentication process.
...
::fiqure-img{source="/Images/image (139).png" width=254}

<!-- <img src="/Images/image (139).png" alt="" width="254"> -->
...
- After successfully logging in, click **Stop Recording** <img src="/Images/image (135).png" alt="" width="15%" data-size="line" style="display:inline; margin:0px; margin-bottom:0px;">button in the ZeroThreat Recorder window.
...
- Choose the scanning server and click on start scan and the scan will start immediately. <img src="/Images/image (136).png" alt="" style="display:inline; width:170px; margin:5px 0px; translate: var(--tw-translate-x) -0px;">
