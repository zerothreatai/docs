...
- Navigate to the **Authenticated Scan** section and click on **Start Authenticated Scan** <img src="/image (132).png" width="200px" alt="" data-size="line" style="display:inline; margin:0px; margin-bottom:0px;"> button.
...
- Click **Record Login State** button
  <img src="/image (134).png" width="15%" alt="" data-size="line" style="display:inline; margin:0px; margin-bottom:0px;"> in the Recorder window to begin capturing the authentication process.
...
- After successfully logging in, click **Stop Recording** <img src="/image (135).png" alt="" width="15%" data-size="line" style="display:inline; margin:0px; margin-bottom:0px;">button in the ZeroThreat Recorder window.
