...
- After successfully logging in, click **Stop Recording** <img src="/image (135).png" alt="" width="15%" data-size="line" style="display:inline; margin:0px; margin-bottom:0px;">button in the Zero Threat Recorder window.
