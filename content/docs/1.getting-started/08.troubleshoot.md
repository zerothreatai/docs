...
> 💡**Tip:** If the extension icon is missing from your toolbar, click on the puzzle icon (<img src="/images/extension_icon.png"/>) in Chrome and pin it for quick access.
