...
1.  **Enter the URL:**&#x20;
    ...
    <img src="/images/image (92).png" alt="" data-size="original" style="display:block; " >
...
2.  **Choose a Scanning Server:**&#x20;
    ...
    <img src="/images/image (94).png" alt="" data-size="original" style="display:block;" >
...
3. **Start the Scan:**&#x20;
   - Click the Start Scan button <img src="/images/image (95).png" alt="" data-size="inline" width="100px" style="display:inline; margin:0px;"> to initiate the scan. The scan will begin almost immediately.
