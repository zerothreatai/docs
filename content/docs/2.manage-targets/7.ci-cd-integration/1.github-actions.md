...
3. Click on the **GitHub Actions** icon in ZeroThreat to open the [**GitHub Actions Marketplace**](https://github.com/marketplace/actions/zerothreat-ai-dast-scanner), where you’ll find the official [**ZeroThreat AI DAST Scanner**](https://github.com/marketplace/actions/zerothreat-ai-dast-scanner) from the marketplace.
***
...
### Step 5: Add ZT_TOKEN as a GitHub Secret (optional)

It is recommended and advised to use the ZT_TOKEN as a GitHub Secret and avoid hardcoding or exposing it.
