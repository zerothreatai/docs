...
Whether you're running periodic scans or have a fully automated CI/CD pipeline, this integration ensures that vulnerabilities get visibility and focus within your GitHub repository.
...
###### You can only create an issue for one vulnerability at a time, this is done to avoid cluttering your Repository. We recommend creating issues only for the vulnerabilities that have impact, and are confirmed and verified.
::
...
###### It is important that you don't remove the two labels **ZeroThreatAI** and **ZT-ME0Y8OX39319** (ZT-id). These two labels are used to enable bi-directional sync between ZeroThreat Portal and GitHub. Removing them will stop the sync.
::
...
* Add comments from within ZeroThreat—they will be synced back to the GitHub issue.
