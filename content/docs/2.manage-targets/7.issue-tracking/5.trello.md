...
* You’re on the Enterprise plan in ZeroThreat, or any other plan that includes Issue Tracking Integrations (The target must also be associated with the subscription). Check the [**ZeroThreat Plans**](/docs/plans/zerothreat-plans) page for more details.
...
2. Click the **Create Card** (<img src="/Images/image (484).png" alt="" data-size="line">) button.
