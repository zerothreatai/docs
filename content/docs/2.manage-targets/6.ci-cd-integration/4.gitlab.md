...
title: Gitlab
seo.title : GitLab Integration – Integrate Security Scans with ZeroThreat
...
seo.description : Automatically run ZeroThreat scans via GitLab CI/CD. Ensure each merge request is tested for vulnerabilities before deployment.
---
...
The job will begin and a scan will be triggered in the ZeroThreat portal.
