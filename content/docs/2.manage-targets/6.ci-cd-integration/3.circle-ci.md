...
title: Circle Ci
seo.title : CircleCI Integration – Integrate Security Scans with ZeroThreat
...
seo.description : Integrate  ZeroThreat scans into CircleCI workflows—automate API and web app testing during build and deployment cycles.
---
...
Once confirmed, a unique **ZT_Token** will be generated for this target. This token is used to start scans for its associated target from the CI/CD.
...
Click on the **CircleCI** (<img src="/Images/image (241).png" alt="" data-size="line">) icon in ZeroThreat. This will redirect you to the [**ZeroThreat Orb page**](https://circleci.com/developer/orbs/orb/zerothreat-ai/dast-scanner) on the [CircleCI Orb Marketplace](https://circleci.com/developer/orbs). Go through this page for the Quick Start guide, required inputs, and other necessary information.
...
###### Learn more about customizing and using Orbs in CircleCI’s official documentation: [**Using Orbs in CircleCI**](https://circleci.com/docs/orbs/use/orb-intro/)
::
...
2. Click the **“Trigger Pipeline”** (<img src="/Images/image (244).png" alt="" data-size="line">) button.
...
Head over to our guide on [**Reviewing Scan Reports**](../../manage-scans/scan-report/ 'mention') to learn and analyze different sections of the scan report.
