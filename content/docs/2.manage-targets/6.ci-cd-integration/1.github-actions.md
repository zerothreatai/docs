...
2. Navigate to the **Actions** tab (<img src="/Images/image (222).png" alt="" data-size="line">).
3. Click **"New Workflow"** (<img src="/Images/image (223).png" alt="" data-size="line">) and select **"Simple Workflow"** as your starting template.
...
1. Go to your GitHub repository settings (<img src="../../.gitbook/assets/image (14).png" alt="" data-size="line">).
...
1. Go to the **Actions(**<img src="../../.gitbook/assets/image (9).png" alt="" data-size="line">**)**&#x74;ab in your GitHub repository.
