...
3. Click on the **GitHub Actions** icon in ZeroThreat to open the [**GitHub Actions Marketplace**](https://github.com/marketplace?type=actions), where you’ll find the official [**ZeroThreat AI DAST Scanner**](https://github.com/marketplace/actions/zerothreat-ai-dast-scanner) from the marketplace.
