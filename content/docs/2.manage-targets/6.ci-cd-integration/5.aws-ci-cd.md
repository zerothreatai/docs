...
* You’re on the Enterprise plan in ZeroThreat, or any other plan that includes CI/CD features. (The target must also be associated with the subscription). Check the [**ZeroThreat Plans**](/docs/plans/zerothreat-plans) page for more details.
