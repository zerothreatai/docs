...
* For example, `example.com/admin` and `example.com/client` can each be scanned as their own target.
* Each scan needs to be triggered separately **scans will not run in parallel.**
